...
export function LMSHero() {
  return (
    <section className="relative pt-24 pb-24 px-6 min-h-[90vh] overflow-hidden flex items-center bg-transparent">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
        ...
        <div className="text-center lg:text-left">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/60 border border-cyan-200 text-cyan-700 text-[10px] font-black uppercase tracking-[0.3em] mb-8 shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-black mb-8 leading-[0.85] tracking-tighter text-[#0F172A] font-heading uppercase"
          >
            Custom LMS <br />
            <span className="text-cyan-600">Made Easy.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base text-slate-900 mb-12 max-w-lg mx-auto lg:mx-0 leading-relaxed font-black uppercase tracking-[0.25em] text-[10px] opacity-80"
          >
          ...
          >
            ...
            <button className="flex items-center gap-3 text-slate-900 font-black uppercase tracking-widest text-[10px] hover:text-cyan-600 transition-colors group">
              <div className="w-12 h-12 rounded-full border border-black/10 flex items-center justify-center bg-white/60 backdrop-blur-xl group-hover:border-cyan-600 transition-all shadow-sm">
                <Play className="w-4 h-4 fill-slate-900 group-hover:fill-cyan-600" />
              </div>
              Explore Platform
            </button>
          </motion.div>
        ...
        <div className="relative h-[500px] lg:h-[650px] flex items-center justify-center pointer-events-none pt-20">
           <div className="relative w-full max-w-[420px] aspect-square">
              ...
              {[
                { color: "bg-cyan-500", size: "w-8 h-8", duration: 18, delay: 0, scale: 1.4, glow: "rgba(6,182,212,0.6)" },
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                 <motion.div 
                    animate={{ 
                      scale: [1, 1.1, 1],
                      boxShadow: ["0 0 30px rgba(15,23,42,0.1)", "0 0 50px rgba(15,23,42,0.2)", "0 0 30px rgba(15,23,42,0.1)"]
                    }}
                    transition={{ duration: 3, repeat: Infinity }}
                    className="w-16 h-16 bg-[#0F172A] rounded-3xl border border-white/10 flex items-center justify-center shadow-2xl relative overflow-hidden"
                 >
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-transparent"></div>
                    {/* Core Neural Pulse */}
                    <div className="relative">
                       <div className="w-3 h-3 bg-cyan-400 rounded-full animate-pulse shadow-[0_0_15px_#22d3ee]"></div>
              ...
              <div className="absolute inset-0 bg-cyan-600/5 blur-[150px] rounded-full animate-pulse"></div>
           </div>
        </div>
      </div>
    </section>
